...
Maximum Number of Abiguous Characters (Ns) <= `r maxNs` :: Reads meeting that criteria: `r table(factor(ReadData$LucyLength <= maxNs,levels=c(FALSE,TRUE)))[2]`

Maximum Length of a Homopolymer Run <= `r maxhomopol` :: Reads meeting that criteria: `r table(factor(ReadData$LucyLength <= maxhomopol,levels=c(FALSE,TRUE)))[2]`
